        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { title: 'Banking & Savings', items: [
              ...
              { label: 'CD Laddering Strategy', href: '/guides/cd-laddering-guide' },
              { label: 'Bank Bonuses: Earn $500+ in 2026', href: '/guides/bank-bonuses-guide-2026' },
            ...
            { title: 'Budgeting & Planning', items: [
              ...
              { label: 'Fixed vs Adjustable Rate Mortgages', href: '/guides/fixed-vs-adjustable-rate-mortgage-guide' },
